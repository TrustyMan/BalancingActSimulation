...
define( function( require ) {
  ...
  function BAIntroModel() {
    ...
    this.addMass( new SmallTrashCan( new Vector2( 4.2, 0 ), false ) );
    this.addMass( new TinyRock( new Vector2( 4.7, 0 ), false ) );
    this.addMass( new TinyRock( new Vector2( 5.2, 0 ), false ) );
  }
